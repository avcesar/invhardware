...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { active: @network.active, domain: @network.domain, nameserver: @network.nameserver, net: @network.net, password: @network.password, user: @network.user }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { active: @network.active, domain: @network.domain, nameserver: @network.nameserver, net: @network.net, password: @network.password, user: @network.user }
    assert_redirected_to network_path(assigns(:network))
  end
